...
public class SlideColorPanel extends JPanel {
	...
	public SlideColorPanel() {
		rSlider = new JSlider(JSlider.HORIZONTAL, 0,255,0); // horizontal slider
		rSlider.setMajorTickSpacing(50);
		rSlider.setMinorTickSpacing(10);
		rSlider.setPaintTicks(true);   // ticks on slider
		rSlider.setPaintLabels(true); // labels on slider
		rSlider.setAlignmentX(Component.LEFT_ALIGNMENT);  // starts at left --> 0 at left
